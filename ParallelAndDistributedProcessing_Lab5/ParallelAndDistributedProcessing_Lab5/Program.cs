...
using ParallelAndDistributedProcessing_Lab5.Benchmarks;
...
public class Program
{
    ...
    {
        Console.WriteLine("Would you like to run ForkJoin threshold benchmarks (warning, to do so the program must be ran in release mode)? y/n");
        ...
        if (key == "y")
        {
            ...
            BenchmarkRunner.Run<ForkJoinThresholdBenchmarks>(config, args);
        }
